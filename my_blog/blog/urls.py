...
from .views import Home, PostDetail, CreatePost, \
                   EditPost, DeletePost, CreateCategory, \
                   CategoryView, CreateComment, EditComment, \
                   DeleteComment, EditProfile, ImportPost, CreateProfile
...
urlpatterns = [
    ...
    path('post/<int:pk>/add_comment/',
         CreateComment.as_view(), name='add_comment'),
    ...
    path('user/edit_profile/<int:pk>',
         EditProfile.as_view(), name='edit_profile'),
    path('user/create_profile',
